...
def blast_map(fragment1):
    command = f"""
    samtools faidx {hla_ref} {fragment1}  | bcftools consensus -H 1 {vcf} >{outdir}/{fragment1}_hap1.fasta
    samtools faidx {hla_ref} {fragment1}  | bcftools consensus -H 2 {vcf} >{outdir}/{fragment1}_hap2.fasta
